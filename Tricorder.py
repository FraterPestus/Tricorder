# Python Code for Tricorder based on Raspberry Pico or Zero, not sure yet
...
# 6.    Heartbeat sensor & Blood Oxymeter       (not suitable for medical diagnose!)
...
#       show free space on data storage (if storage will be implemented)
